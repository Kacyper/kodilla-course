...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://kacyper.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        WebDriver driverTrello = new SafariDriver();
        driverTrello.get(TRELLO_URL);

        driverTrello.findElement(By.id("user")).sendKeys("kksykiewicz@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("raXgyh-syjbim-1wadty");
